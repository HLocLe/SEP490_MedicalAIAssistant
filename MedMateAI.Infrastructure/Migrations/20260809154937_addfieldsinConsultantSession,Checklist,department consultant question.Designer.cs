...
namespace MedMateAI.Infrastructure.Migrations
{
    ...
    [Migration("20260809154937_addfieldsinConsultantSession,Checklist,department consultant question")]
    partial class addfieldsinConsultantSessionChecklistdepartmentconsultantquestion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedMateAI.Domain.Entities.UserSubscriptionUsage", b =>
                {
                    ...
                    b.HasIndex("UserSubscriptionId", "QuotaId", "CycleStart", "CycleEnd")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
